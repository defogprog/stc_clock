...
// 0x98
__sbit __at(__SFR_SCON^7) SM0_FE;
...
__sbit __at(__SFR_IE^6) ELVD;
__sbit __at(__SFR_IE^5) EADC;
...
// 0xB8
__sbit __at(__SFR_IP^7) PPCA;
__sbit __at(__SFR_IP^6) PLVD;
__sbit __at(__SFR_IP^5) PADC;
...
// 0xD8
__sbit __at(__SFR_CCON^7) CF;
__sbit __at(__SFR_CCON^6) CR;
__sbit __at(__SFR_CCON^1) CCF1;
__sbit __at(__SFR_CCON^0) CCF0;
